...
native_timer_label: "iPhone純正タイマー連携 (Beta)",
    ...
    calendar_title: "トレーニングカレンダー",
  monthly_count: "今月のトレーニング回数",
  times: "回",
  no_workout_day: "この日のトレーニング記録はありません。",
  },
  en: {
    home: "Home",
...
native_timer_label: "iPhone Native Timer (Beta)",
  ...
  monthly_count: "Workouts this month",
  times: "times",
  no_workout_day: "No workout records for this day.",
  },
  it: {
    home: "Home",
...
native_timer_label: "Timer Nativo iPhone (Beta)",
    ...
    calendar_title: "Calendario Allenamenti",
  monthly_count: "Allenamenti questo mese",
  times: "volte",
  no_workout_day: "Nessun allenamento in questo giorno.",
  }
};
